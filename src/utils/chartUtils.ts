 ...
 */
export function safeFilename(prefix: string, ext: string): string {
 ...
 */
export function downloadText(content: string, filename: string, mime = 'text/plain'): boolean {
 ...
 */
export function downloadJson(rows: unknown, prefix = 'chart'): boolean {
 ...
 */
function findSvg(container: ParentNode): SVGSVGElement | null {
 ...
 */
export function exportSvg(container: ParentNode, prefix = 'chart'): boolean {
...
export function sparklinePath(
  ...
  { width = 80, height = 20, padding = 1 }: { width?: number; height?: number; padding?: number } = {}
) {
 ...
 */
export function colorForIndex(index: number, scale: string[] = DEFAULT_SCALE): string {
 ...
 */
export function buildColorMap(categories: string[], scale: string[] = DEFAULT_SCALE): Record<string, string> {
...
export { buildCsv, exportChartDataAsCsv } from '../lib/chartUtils';
