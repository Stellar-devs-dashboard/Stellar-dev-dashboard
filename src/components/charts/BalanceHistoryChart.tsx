  ...
  const balanceData = useMemo(() => {
    ...
    return accountData.balances.map((b) => {
      if (b.asset_type === 'native') {
        return { asset: 'XLM', balance: parseFloat(b.balance) || 0, limit: null as number | null }
      }
      if (b.asset_type === 'liquidity_pool_shares') {
        return { asset: 'LP', balance: parseFloat(b.balance) || 0, limit: null as number | null }
      }
      return {
...
function LiveBadge({ pulse, active, updatedAt }: LiveBadgeProps) {
  return (
    <div
