...
export async function fetchPrices(
  assetCodes: string[] = ['XLM'],
  options: FetchPricesOptions = {},
): Promise<Record<string, AssetPriceQuote>> {
  ...
  const fetchFreshPrices = async () => {
    ...
    const prices: Record<string, AssetPriceQuote> = {};
    for (const code of assetCodes) {
 ...
 */
export async function fetchXLMPrice(options: FetchPricesOptions = {}) {
